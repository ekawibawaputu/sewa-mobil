<x-front-layout>
       ...
       <section class="bg-darkGrey relative py-[70px]">
        <div class="container">
            ...
            <div class="flex items-center gap-5 lg:justify-between">
                <!-- Form Card -->
                <form action="{{ route('front.checkout.store', $item->slug )}}" method="POST" class="bg-white p-[30px] pb-10 rounded-3xl max-w-[490px] w-full" x-data="app"
                    x-cloak id="checkoutForm">
                    @csrf
                    @method('POST')
    ...
    <script>
        // on checkoutButton click, submit form
