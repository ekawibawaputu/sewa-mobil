                ...
                @foreach ($similiarItems as $similiarItem)
                    ...
                    <div class="card-popular">
                        <div>
                            ...
                            <p class="text-sm font-normal text-secondary">{{ $similiarItem->type ? $similiarItem->type->name : '-'}}</p>
                        ...
                        <div class="flex items-center justify-between gap-1">
                            ...
                            <p class="text-sm font-normal text-secondary">
                                <span class="text-base font-bold text-primary">$ {{number_format($similiarItem->price )}}</span>/day
                            </p>
                            <!-- Rating -->
            ...
            data() {
                return {
                    ...
                    thumbnails: [
                        ...
                        // {
                        //     id: 2,
                        //     url: "/images/thumbnail-02.webp"
                        // },
                        // {
                        //     id: 3,
                        //     url: "/images/thumbnail-03.webp"
                        // },
                        // {
                        //     id: 4,
                        //     url: "/images/thumbnail-04.webp"
                        // },
                    ],
                }
            },
